...
public class WebDriverManager {
     ...
     */
    public WebDriver initDriver(BrowserTypes browserType) {
    ...
    public WebDriver initDriver() {
        BrowserTypes browserType = Enum.valueOf(BrowserTypes.class, configProp.getProperty("browser"));
        return createWebDriverInstance(browserType);
    }
     ...
     * @return Webdriver object after initializing   
     */
    private WebDriver createWebDriverInstance(BrowserTypes browserType){
        switch (browserType) {
            case FIREFOX :
